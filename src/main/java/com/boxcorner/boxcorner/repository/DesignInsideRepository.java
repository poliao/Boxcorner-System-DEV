...
@Repository
public interface DesignInsideRepository extends JpaRepository<DesignInside, Integer> {

        @Query(value = """
                        SELECT * FROM design_inside d
                        WHERE
                        ...
                        ORDER BY d.id DESC
                        """, countQuery = "SELECT count(*) FROM design_inside", nativeQuery = true)
        Page<DesignInside> findByFilters(
        ...
        @Query(value = """
                        ...
                        """, countQuery = "SELECT count(*) FROM design_inside", nativeQuery = true)
        Page<DesignInside> findByAllSorted(
                        @Param("id") String id,
                        @Param("folderName") String folderName,
                        @Param("jobDetails") String jobDetails,
                        @Param("jobOwner") String jobOwner,
        ...
        @Query(value = "SELECT DISTINCT job_details FROM design_inside " +
        ...
        @Query(value = "SELECT DISTINCT job_owner FROM design_inside " +
        ...
        @Query(value = "SELECT DISTINCT assignee FROM design_inside " +
        ...
        @Query(value = "SELECT DISTINCT process_status FROM design_inside " +
        ...
        @Query(value = "SELECT DISTINCT confirm_status FROM design_inside " +
        ...
        @Query(value = "select  count(id) as backlog from design_inside " +
                        "where assignee='รอผู้รับผิดชอบยืนยัน'", nativeQuery = true)
        Integer countBacklog();

        @Query(value = "select count(t.id) from design_inside t " +
