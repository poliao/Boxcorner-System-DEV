...
@Entity
@Table(name = "qc_remaining_destroy_staff")
@Data
...
public class QcRemainingDestroyStaff extends BaseEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id;

    @Column(name = "qc_remaining_destroy_id")
    private Integer qcRemainingDestroyId;
