...
export class Dcsm04DetailComponent implements OnInit {
  ...
  updateStatus(){
    ...
    this.dcsm04Service.updateStatus(this.designForm.getRawValue().id).subscribe((response) => {
  ...
  updateStatusWorking(){
    this.loadingService.show();
    this.dcsm04Service.updateStatusWork(this.designForm.getRawValue().id).subscribe((response) => {
       this.designForm.patchValue(response);
       this.checkButtonVisibility();
      this.loadingService.hide();
  ...
  updateStatusComplete(){
    this.loadingService.show();
    this.dcsm04Service.updateStatusComplete(this.designForm.getRawValue().id).subscribe((response) => {
       this.designForm.patchValue(response);
       this.checkButtonVisibility();
      this.loadingService.hide();
